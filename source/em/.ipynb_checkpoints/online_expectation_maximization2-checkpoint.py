from transforms.online_transform_function2 import OnlineTransformFunction2
...
class OnlineExpectationMaximization2(ExpectationMaximization):
    def __init__(self, cont_indices, ord_indices, window_size=200, sigma_init=None):
        self.transform_function = OnlineTransformFunction2(cont_indices, ord_indices, window_size=window_size)
